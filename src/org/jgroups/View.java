...
public class View implements Comparable<View>,
    SizeStreamable, Iterable<Address>, Constructable<View> {
    ...
    private static final boolean suppress_view_size =
        Boolean.getBoolean(Global.SUPPRESS_VIEW_SIZE);
    ...
    /**
     * Returns the underlying array. The caller <em>must not</em> modify the contents. Should not be
     * used by application code ! This method may be removed at any time, so don't use it !
     */
    ...
    /**
     * Returns the difference between 2 views from and to. It is assumed that view 'from' is
     * logically prior to view 'to'.
     *
     * @param from The first view
     * @param to The second view
     * @return an array of 2 Address arrays: index 0 has the addresses of the joined member, index 1
     * those of the left members
     */
    ...
    /**
     * Checks if two views have the same members regardless of order. E.g. {A,B,C} and {B,A,C}
     * returns true
     */
    ...
    /**
     * Checks if two views have the same members observing order. E.g. {A,B,C} and {B,A,C} returns
     * false, {A,C,B} and {A,C,B} returns true
     */

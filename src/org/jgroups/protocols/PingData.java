...
/**
 * Encapsulates information about a cluster node, e.g. local address, coordinator's address, logical
...
public class PingData implements SizeStreamable, Constructable<PingData> {
    ...
    private static final byte is_server = 1;
    ...
    public PingData(Address sender, boolean is_server, String logical_name,
    ...
    public String toString() {
        ...
        if (isCoord())
            ...
            sb.append(", server");
        if (mbrs != null)
            sb.append(", mbrs=").append(mbrs.size());
        return sb.toString();
    }

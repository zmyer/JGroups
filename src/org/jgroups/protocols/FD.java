...
public class FD extends Protocol {
    ...
    protected void sendHeartbeatResponse(Address dest) {
        Message hb_ack=new Message(dest).setFlag(Message.Flag.OOB);
    ...
    protected class Monitor implements Runnable {
        ...
        public void run() {
            ...
            Message hb_req=new Message(dest).setFlag(Message.Flag.OOB).putHeader(id, new FdHeader(FdHeader.HEARTBEAT));
    ...
    protected final class BroadcastTask implements Runnable {
        ...
        public void run() {
            ...
            Message suspect_msg=new Message().setFlag(Message.Flag.OOB).putHeader(id, hdr);
            if(log.isDebugEnabled())

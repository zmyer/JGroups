...
/**
 * Protocol which is used by {@link org.jgroups.blocks.atomic.CounterService} to provide a
...
public class COUNTER extends Protocol {
    ...
    protected void sendCounterNotFoundExceptionResponse(Address dest, Owner owner,
        String counter_name) {
    ...
    protected static Buffer streamableToBuffer(byte req_or_rsp, byte type,
        Streamable obj) throws Exception {
    ...
    protected static Streamable streamableFromBuffer(byte[] buf, int offset,
    ...
    protected static final Request requestFromBuffer(byte[] buf, int offset,
        int length) throws Exception {
    ...
    protected static final Response responseFromBuffer(byte[] buf, int offset,
        int length) throws Exception {
        ByteArrayInputStream input = new ByteArrayInputStream(buf, offset, length);
        DataInputStream in = new DataInputStream(input);
    ...
    protected static void writeReconciliation(DataOutput out, String[] names, long[] values,

...
/**
 * Maintains bridges and routing table. Does the routing of outgoing messages and dispatches
 * incoming messages to the right members.<p/> A Relayer cannot be reused once it is stopped, but a
 * new Relayer instance must be created.
 *
 * @author Bela Ban
 * @since 3.2
 */
public class Relayer {
    ...
    /**
     * Flag set when stop() is called. Since a Relayer should not be used after stop() has been
     * called, a new instance needs to be created
     */
...
//
     ...
     * @throws Throwable
     */
    public void start(List<RelayConfig.BridgeConfig> bridge_configs, String bridge_name,
        final String my_site_id)
        throws Throwable {
        if (done) {
    ...
    protected class Bridge extends ReceiverAdapter {
        ...
        /**
         * The view contains a list of SiteUUIDs. Adjust the routing table based on the SiteUUIDs
         * UUID and site
         */

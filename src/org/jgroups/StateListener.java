...
public interface StateListener {
     ...
     * @throws Exception if the streaming fails, any exceptions should be thrown so that the state
     * requester can re-throw them and let the caller know what happened
    ...
    /**
     * Allows an application to read a state through a provided InputStream. After the state has
     * been read the InputStream doesn't need to be closed as stream closing is automatically done
     * when a calling thread returns from this callback.
     *
     * @param input the InputStream
     * @throws Exception if the streaming fails, any exceptions should be thrown so that the state
     * requester can catch them and thus know what happened

...
public class Membership {
     ...
     * the list, so that the list passed in as parameters is not the same reference as the list that
     * the membership class uses
     *
    ...
    /**
     * Clears the membership and adds all members of v This method will clear out all the old
     * members of this membership by invoking the {@code Clear} method. Then it will add all the all
     ...
     *
     * @param new_mems - a vector containing a list of members (Address) to be added to this
     * membership
     * @param suspects - a vector containing a list of members (Address) to be removed from this
     * membership
     */
     ...
     * current size of this Membership object.
     */

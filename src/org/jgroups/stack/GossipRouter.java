 ...
 * <p/>
 * Note that a GossipRouter is also a good way of running JGroups in Amazon's EC2 environment which
 * (as of summer 09) doesn't support IP multicasting.
 *
 * @author Bela Ban
...
public class GossipRouter extends ReceiverAdapter implements ConnectionListener {
    ...
    /**
     * Lifecycle operation. Called after create(). When this method is called, the managed
     * attributes have already been set.<br> Brings the Router into a fully functional state.
     */

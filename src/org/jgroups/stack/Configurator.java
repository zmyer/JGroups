...
public class Configurator {
    ...
    Protocol setupProtocolStack(List<ProtocolConfiguration> config) throws Exception {
        return setupProtocolStack(config, stack);
    }

    Protocol setupProtocolStack(ProtocolStack copySource) throws Exception {
    ...
    /**
     * Creates a new protocol given the protocol specification. Initializes the properties and
     * starts the up and down handler threads.
     *
     * @param prot_spec The specification of the protocol. Same convention as for specifying a
     * protocol stack. An exception will be thrown if the class cannot be created. Example:
     ...
     *
     * @return StackType.IPv4 for IPv4, StackType.IPv6 for IPv6, StackType.Unknown if the version
     * cannot be determined
     */
    public static StackType determineIpVersionFromAddresses(
        Collection<InetAddress> addrs) throws Exception {
    ...
    */
    public static void setDefaultValues(List<ProtocolConfiguration> protocol_configs,
    ...
    public static Object getValueFromProtocol(Protocol protocol,
        String field_name) throws IllegalAccessException {
    ...
    public static void resolveAndAssignFields(Object obj, Map<String, String> props)
        throws Exception {
    ...
    private static void removeDeprecatedProperties(Object obj,
        Map<String, String> props) throws Exception {
    ...
    public static class InetAddressInfo {
         ...
         */
        static void parameterizedTypeSanityCheck(
            ParameterizedType pt) throws IllegalArgumentException {

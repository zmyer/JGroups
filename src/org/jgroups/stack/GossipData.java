...
public class GossipData implements SizeStreamable {
    ...
    public GossipData(GossipType type, String group, Address addr, String logical_name,
        PhysicalAddress physical_addr) {
        this(type, group, addr);
    ...
    public GossipData(GossipType type, String group, Address addr, byte[] buffer, int offset,
        int length) {
        this(type, group, addr);
        this.buffer = buffer;
        this.offset = offset;

...
/**
 * IpAddress with a 'semi'-UUID to prevent reincarnation when the port is fixed. The randomness is
 * given through a long and an int. On 64-bit architectures, this increases the memory size from 24
 * to 32 bytes per instance.<p> See https://issues.jboss.org/browse/JGRP-2080 for details
 *
 * @author Bela Ban
 * @since 4.0
 */

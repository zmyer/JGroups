...
public class IpAddress implements PhysicalAddress, Constructable<IpAddress> {
     ...
     * @throws java.lang.ClassCastException - if the specified object's type prevents it from being
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true; // added Nov 7 2005, makes sense with canonical addresses

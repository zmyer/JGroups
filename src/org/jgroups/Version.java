 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.42.2.11.8.1 2009/09/25 21:52:37 dereed Exp $
 * Holds version information for JGroups.
 */
public class Version {
    public static final short major = 2;
    public static final short minor = 4;
    public static final short micro = 5;
    public static final String description="2.4.5.GA";

    public static final short version=encode(major, minor, micro);
    public static final String string_version=print(version);
    public static final String cvs="$Id: Version.java,v 1.42.2.11.8.1 2009/09/25 21:52:37 dereed Exp $";
    ...
    public static void main(String[] args) {
        System.out.println("\nVersion: \t" + description + "_JGRP-1060");

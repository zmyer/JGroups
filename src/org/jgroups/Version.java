 ...
 *
 * @author Bela Ban
 * @version $Id: Version.java,v 1.42.2.14.2.1 2010/06/08 18:47:13 dereed Exp $
...
public class Version {
    ...
    public static final String cvs="$Id: Version.java,v 1.42.2.14.2.1 2010/06/08 18:47:13 dereed Exp $";
    ...
    public static void main(String[] args) {
        System.out.println("\nVersion: \t" + description + "_JGRP-1207");

 ...
 * for major, minor and micro version numbers. We have 5 bits for major and minor version numbers
 * each and 6 bits for the micro version. This gives: X = 0-31 for major versions Y = 0-31 for minor
 * versions Z = 0-63 for micro versions
 *
 * @author Bela Ban Holds version information for JGroups.
 */
...
public class Version {
    ...
    private static final short micro;
    ...
    private static final String CODENAME = "jgroups.codename";
    ...
    /**
     * Checks whether ver is binary compatible with the current version. The rule for binary
     * compatibility is that the major and minor versions have to match, whereas micro versions can
     * differ.
     *
     * @param ver version
     */

...
public class GridFilesystem {
    ...
    private final ReplCache<String, GridFile.Metadata> metadata;
    private final int default_chunk_size;
    private final short default_repl_count;
     ...
     * @param default_chunk_size default chunk size
     */
    public GridFilesystem(ReplCache<String, byte[]> data,
    ...
    private File getFile(String pathname, int chunk_size) {
    ...
    private File getFile(String parent, String child, int chunk_size) {
    ...
    private File getFile(File parent, String child, int chunk_size) {
        return new GridFile(parent, child, metadata, chunk_size, this);
    }
    ...
    private OutputStream getOutput(String pathname, boolean append, short repl_count,

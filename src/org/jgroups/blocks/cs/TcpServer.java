...
/**
 * Class that manages allows to send and receive messages via TCP sockets. Uses 1 thread/connection
 * to read messages.
 *
...
public class TcpServer extends TcpBaseServer {
    ...
    /**
     * Creates an instance of {@link TcpServer} that creates a server socket and listens for
     * connections. The end port defaults to (port + 50).  Needs to be started next.
     *

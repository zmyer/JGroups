...
/**
 * Blocking IO (BIO) connection. Starts 1 reader thread for the peer socket and blocks until data is
 * available. Calls {@link TcpServer#receive(Address, byte[], int, int)} when data has been
 * received.
 *
 * @author Bela Ban
 * @since 3.6.5

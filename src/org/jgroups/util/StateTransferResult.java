...
/**
 * Encapsulates the result of a state transfer. When buffer is set, then this is the result of a
 * state transfer with STATE_TRANSFER. When exception is non-null, then an exception occurred. When
 * both fields are null, then the (streaming) state transfer was successful.
 *
 * @author Bela Ban
 * @since 3.0
 */

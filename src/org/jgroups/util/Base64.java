 ...
 * encoding them, not inserting linefeeds, and encoding using the URL-safe and Ordered
 * dialects.</p>
 *
 ...
 * {@link #encodeFromFile} where estimated buffer size was wrong for files of size 31, 34, and 37
 ...
 * support for specifying a class loader when using the {@link #decodeToObject(java.lang.String,
 * int, java.lang.ClassLoader)} method.</li> <li>v2.3.3 - Changed default char encoding to US-ASCII
 * which reduces the internal Java footprint with its CharEncoders and so forth. Fixed some javadocs
 * that were inconsistent. Removed imports and specified things like java.io.IOException explicitly
 ...
 * different mechanism with streams and stuff).</li> <li>v2.3.1 - Added {@link
